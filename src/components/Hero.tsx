        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 bg-primary text-primary-foreground rounded-[2rem] p-8 lg:p-14 relative overflow-hidden border border-white/5 min-h-[520px] flex flex-col justify-center">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-lg bg-secondary/10 border-r-4 border-secondary text-white/90 text-xs md:text-sm font-bold mb-8 tracking-wide font-manrope">
                منذ 2011 — جودة صناعية معتمدة
              </div>

              <h1 className="font-sora font-extrabold text-white leading-[1.2] text-4xl md:text-5xl lg:text-6xl mb-6">
                صناعة أكياس بلاستيكية
                <br />
                <span className="text-secondary border-b-4 border-secondary/20">عالية الجودة</span>
              </h1>

              <p className="text-base md:text-lg text-white/70 max-w-2xl mb-10 leading-relaxed font-tajawal">
                نقدم حلول تعبئة وتغليف مبتكرة تلبي احتياجات الأعمال بأعلى معايير الجودة والاستدامة.
                هندسة دقيقة لكل منتج لضمان الأداء الأمثل.
              </p>
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <div className="relative h-64 lg:h-full min-h-[320px] rounded-[2rem] overflow-hidden border border-primary/10 bg-card shadow-xl">
              ...
              <div className="absolute bottom-6 right-6 left-6 z-10">
                <div className="flex flex-col gap-2">
                  ...
                  <span className="text-white font-bold text-lg font-cairo">خطوط إنتاج مؤتمتة</span>
                  <span className="text-white/70 text-sm font-tajawal">دقة تصنيع تصل إلى 99.9%</span>
                </div>
              </div>
            </div>
