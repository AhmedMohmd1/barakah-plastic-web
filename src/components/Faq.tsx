...
const Faq = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "نوفر 5 فئات من الأكياس (مطبوعة بالشعار، سوفت، قماش، سلوفان، زيبلوك) — كل فئة لها صفحة تفاصيل بمواصفاتها الأساسية. للمقاسات والسماكات الدقيقة لطلبك، تواصل معنا وسنؤكدها لك."
      // TODO: أضِف نطاقات دقيقة للسماكة/المقاس لكل فئة عند توفرها من المصنع
    },
    {
    ...
    },
    {
      ...
      answer: "يختلف الحد الأدنى للطلب حسب نوع المنتج والمواصفات المطلوبة. أخبرنا بالكمية التي تحتاجها عبر نموذج طلب عرض السعر وسنؤكد لك الحد الأدنى المناسب."
      // TODO: استبدل هذا برقم حقيقي (عام أو لكل فئة منتج) عند توفره
    },
    {
      question: "كم تستغرق مدة التوصيل؟",
      answer: "تختلف مدة التوصيل حسب حجم الطلب والمحافظة. نوضح لك الموعد المتوقع عند تأكيد طلبك في عرض السعر."
      // TODO: أضِف نطاق زمني تقريبي (مثال: 3-7 أيام عمل حسب المحافظة) عند توفره
    },
    {
      question: "ما هي طريقة التسعير؟",
      answer: "نحدد السعر بناءً على المنتج والكمية والمواصفات المطلوبة — أرسل تفاصيل طلبك وسنرد بعرض سعر مخصص."
      // TODO: أضِف تفاصيل نموذج التسعير (سعر ثابت/حسب الكمية) عند توفرها
    },
    {
      question: "ما هي طرق الدفع المتاحة؟",
      answer: "تواصل معنا لمعرفة طرق الدفع المتاحة لطلبك."
      // TODO: أضِف طرق الدفع الفعلية (نقدًا، تحويل بنكي، دفعة مقدمة...) عند توفرها
    }
  ];
